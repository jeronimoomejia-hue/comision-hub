...
const faqData: Record<FAQCategory, { question: string; answer: string }[]> = {
  empresas: [
    {
      ...
      answer: "Mensualista es un software B2B que le permite a tu empresa tener su propia plataforma de vendedores independientes. Tú personalizas la plataforma con tu marca, publicas tus gigs, invitas a tus vendedores y ellos venden por ti. Nosotros nos encargamos de la tecnología, comisiones y pagos.",
    },
    {
      question: "¿Puedo empezar sin pagar nada?",
      answer: "Sí, el plan Freemium es completamente gratis. Puedes registrar tu empresa, personalizar tu plataforma y publicar hasta 5 gigs. Solo cobramos un 15% de fee por venta + los costos de pasarela (3% + $1.000 COP por transferencia).",
    },
    {
      question: "¿Qué diferencia hay entre los planes?",
      answer: "Freemium: hasta 5 gigs, códigos manuales, fee del 15%. Premium (€100/mes): gigs ilimitados, sin fee del 15%, cupones de descuento y chat vendedor-empresa. Enterprise (€300/mes): todo lo de Premium + integración automática de códigos, dominio personalizado y marca blanca.",
    },
    {
  ...
  vendedores: [
    ...
    },
    {
      ...
      answer: "No, en Mensualista cada empresa tiene su red privada de vendedores. Los vendedores que registras solo ven y venden tus gigs.",
    },
  ],
  pagos: [
    {
