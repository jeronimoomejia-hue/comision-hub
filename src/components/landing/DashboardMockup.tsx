...
import { TrendingUp, DollarSign, Users, ShoppingCart, Bell, Search, BarChart3, ArrowUpRight, ChevronRight, Package, Star, Zap, Bot } from "lucide-react";
  ...
  <svg viewBox="0 0 200 60" className="w-full h-16">
    ...
    <defs>
      <linearGradient id="purpleGrad" x1="0" y1="0" x2="0" y2="1">
        <stop offset="0%" stopColor="hsl(292, 100%, 50%)" />
        <stop offset="100%" stopColor="hsl(292, 100%, 50%)" stopOpacity="0" />
      </linearGradient>
    </defs>
  </svg>
);
...
export const DashboardMockup = () => {
  ...
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden bg-primary/[0.03]">
      {/* Background glow */}
      <motion.div
        animate={{ opacity: [0.1, 0.2, 0.1] }}
        transition={{ duration: 5, repeat: Infinity }}
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[900px] h-[600px] rounded-full bg-primary/10 blur-[120px] pointer-events-none"
      />
      ...
      <div className="container mx-auto max-w-6xl relative">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">
            Todo bajo control, <span className="text-primary">en tiempo real</span>
          </h2>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Monitorea ventas, comisiones y rendimiento desde un dashboard diseñado para maximizar tus resultados.
          </p>
        </motion.div>
                    ...
                    <div className="flex items-end gap-1.5 h-16">
                      {barHeights.map((h, i) => (
                        <div key={i} className="flex-1 flex flex-col items-center gap-1">
                          <MiniBar height={h} delay={0.4 + i * 0.08} />
