            ...
            return (
              <div key={company.id} className="flex items-center justify-between px-4 py-3 gap-3">
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-[10px] text-muted-foreground">{company.industry} · {stats.activeServices} productos · {stats.totalSales} ventas</p>
                </div>
            ...
            {selected && (
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2 text-center text-sm">
                  ...
                  <div className="p-2 rounded-lg bg-muted/50"><p className="font-bold">{selected.stats.activeServices}</p><p className="text-[10px] text-muted-foreground">Productos</p></div>
