...
export const extendedServiceDetails: Record<string, ExtendedDetails> = {
  'service-001': {
    ...
    termsHighlights: 'El gig se renueva automáticamente cada mes. Puedes cancelar en cualquier momento sin penalidad.',
  ...
  'service-002': {
    ...
    objections: [
      ...
      { objection: '¿Qué tipo de contratos analiza?', response: 'Laborales, comerciales, arrendamiento, prestación de gigs, y más.' },
...
services.forEach(service => {
  if (!extendedServiceDetails[service.id]) {
    extendedServiceDetails[service.id] = {
      ...
      termsHighlights: 'El gig se presta bajo los términos vigentes al momento de la compra.',
